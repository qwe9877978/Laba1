...
- На каждой итерации берём последнюю цифру текущего числа и прибавляем к результату.  
...
- Используем `StringBuilder` для эффективности(Перенести начало в хвост через добавление Append).
